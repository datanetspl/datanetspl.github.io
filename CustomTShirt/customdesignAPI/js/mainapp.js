...
$(document).ready(function(){
	...
	//ONLOAD
	$("#preview_front").css('background-image', 'url(customdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_front.png) ') ;
	$("#preview_back").css('background-image', 'url(customdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_back.png) ') ;
	...
	$("#o_front").click(function(){
		$y_pos="front";
				$("#preview_front").css('background-image', 'url(customdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_'+$y_pos+'.png) ') ;
				$("#o_front").attr('src','customdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_front.png');
				$("#o_back").attr('src','customdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_back.png');
	...
	$("#o_back").click(function(){
		$y_pos="back";
				$("#preview_back").css('background-image', 'url(customdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_'+$y_pos+'.png) ') ;
				$("#o_front").attr('src','customdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_front.png');
				$("#o_back").attr('src','customdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_back.png');
...
/*=====================SAMPLE ICONS========================*/
	...
	$(".folder_toggle").click(function(){
		...
		$.ajax({
			      url: 'customdesignAPI/control/newcontent.php?folder='+$folder,
			      success: function()
		      	{
		        	$("#toggle_show"+$i ).empty().load("customdesignAPI/control/newcontent.php?folder="+$folder);
		      	}
	    });
	});
/*=====================SAMPLE ICONS over========================*/
